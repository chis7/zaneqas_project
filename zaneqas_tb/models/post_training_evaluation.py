...
class PostTrainingEvaluation(models.Model):
    _name = "training.post.evaluation"
    _description = "Post training Evaluation"
    ...
    extent_objectives_achieved = fields.Selection(
        selection=[
    ...
    performance_rating_before = fields.Selection(
        ...
        string="How do you rate your job performance before the training?", tracking=True, required=True,
    )
    ...
    hindering_factors_supervisor_priorities_other = fields.Boolean(string="Supervising Officer has other priorities",
                                                                   default=False, required=True)
    ...
    hindering_factors_other = fields.Text(string="Others, (Specify)",
                                             default=False, required=True)
    ...
    comments_other = fields.Text(string="Others, specify", required=False)
