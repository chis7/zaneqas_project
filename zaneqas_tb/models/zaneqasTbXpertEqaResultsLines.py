...
class ZaneqasTbXpertEqaResultsLines(models.Model):
    _name = "zaneqas.tb.xpert.eqa.result.lines"
    _description = "Zaneqas TB Xpert EQA Results Lines"
    ...
    zaneqas_tb_xpert_eqa_result_id = fields.Many2one('zaneqas.tb.xpert.eqa.result', string="zaneqas tb xpert eqa result", store=True)
